...
const buildScene = (scene) => {
    ...
    const skybox = scene.createSkyBox("Resources/Env/blue sky.env")
    ...
    airplane.then(function(result){
        ...
        var scenebutton01 = BABYLON.GUI.Button.CreateSimpleButton("but0", "Scene 1");
        scenebutton01.background = "black";
        scenebutton01.color = "white";
        scenebutton01.width = "90px";
        scenebutton01.height = "40px";
        scenebutton01.left = "-30px";
        scenebutton01.horizontalAlignment = BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;
        scenebutton01.onPointerUpObservable.add(function (){
            activeScene = 0;
            console.log(activeScene);
        });
    
        advancedTexture.addControl(scenebutton01);
    
    
        var scenebutton02 = BABYLON.GUI.Button.CreateSimpleButton("but1", "Scene 2");
        scenebutton02.background = "black";
        scenebutton02.color = "white";
        scenebutton02.width = "90px";
        scenebutton02.height = "40px";
        scenebutton02.left = "-30px";
        scenebutton02.top = "50px";
        scenebutton02.horizontalAlignment = BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;
        scenebutton02.onPointerUpObservable.add(function(){
            activeScene = 1;
            console.log(activeScene);
        });
    
        advancedTexture.addControl(scenebutton02);
    
        var scenebutton03 = BABYLON.GUI.Button.CreateSimpleButton("but2", "Scene 3");
        scenebutton03.background = "black";
        scenebutton03.color = "white";
        scenebutton03.width = "90px";
        scenebutton03.height = "40px";
        scenebutton03.left = "-30px";
        scenebutton03.top = "100px";
        scenebutton03.horizontalAlignment = BABYLON.GUI.Control.HORIZONTAL_ALIGNMENT_RIGHT;
        scenebutton03.onPointerUpObservable.add(function(){
            activeScene = 2;
            console.log(activeScene);
        });
    
        advancedTexture.addControl(scenebutton03);
...
const buildScene01 = (scene) => {

    const skybox = scene.createSkyBox("Resources/Env/sky02.env")

    const terrain = BasicScene.importMesh("Resources/Models/", "Environment2.glb", scene.scene, scene.shadowGenerator);
...
const buildScene02 = (scene) => {

    const skybox = scene.createSkyBox("Resources/Env/sky03.env")

    const terrain = BasicScene.importMesh("Resources/Models/", "Environment3.glb", scene.scene, scene.shadowGenerator);
